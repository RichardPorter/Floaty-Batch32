...
set /a "new_sign=((%mpy_a% ^ %mpy_b%)>>31)<<31"
...
set /a "result=%new_sign%|%new_exponent%|%new_mantissa%"
echo %mpy_exponent%
echo %new_sign%
...
set /a "add_b_mantissa=%add_b_mantissa% >> %exponent_diff%"
) ELSE (
